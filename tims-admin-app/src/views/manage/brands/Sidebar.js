  ...
  return (
    ...
    >
      <Form onSubmit={handleSubmit(onSubmit)}  autoComplete="off" role="presentation">
        ...
        <FormGroup>
          <Label for='partnaer'>Partenaire?</Label>
          <Input type='select' id='partnaer' name='partnaer' value={brand.isPartner ? 1 : 0} 
          onChange={e => setBrand({...brand, isPartner: Number(e.target.value) === 0 ? false : true})}>
          ...
          <Label for='image'>
...

            {
              ...
              >
                ...
                <center><img src={`${file_url}/brands/${brand.image}`} alt="image" style={{borderRadius: 5, width: "auto", height: 172, marginBottom: 20}}/></center>
              ...
              <>
              {image1Loading ? <Spinner/> :<FileDropzone editMode = {editMode} onChange = {async (file) => {
