...
const SidebarCategory = ({ open, toggleSidebar, 
  ...
  const [delete1Loading, setDelete1Loading] = useState(false)
  const [image2Loading, setImage2Loading] = useState(false)
  const [delete2Loading, setDelete2Loading] = useState(false)
