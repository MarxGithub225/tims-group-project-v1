...
export const handleLogin = data => {
  return dispatch => {
    ...
    localStorage.setItem('timsProvideruserData', JSON.stringify(data))
...
export const handleLogout = () => {
  return dispatch => {
    ...
    localStorage.removeItem('timsProvideruserData')
...
export const setTokenExpired = () => {
  return dispatch => {
    dispatch({ type: 'TOKEN_EXPIRED', tokenExpired: true })
  }
}
