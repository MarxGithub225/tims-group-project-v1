...
export default class CardView extends Component {
  ...
  render() {
    const { focused,
      ...
      placeholder, imageFront, imageBack, scale, fontFamily, clickable } = this.props;
    ...
    const _render = () => {
      return <FlipCard style={{ borderWidth: 0 }}
    ...
    if(clickable) {
      return <TouchableOpacity style={[s.cardContainer, containerSize]}>
        {_render()}
      </TouchableOpacity>
    }
