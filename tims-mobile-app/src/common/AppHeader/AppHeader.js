...
import { black, blackBg, blackLight, blue, grey, greyLight, mediumSize, primary, secondary, smallSize, white } from '../../../assets/styles/variables';
...
function AppHeader(props) {
      ...
      return (
        <View style={{flexDirection: 'row', alignItems : 'center', justifyContent : (!props.title || !props.hideCart) ? 'space-between' : 'flex-start',  paddingHorizontal: 10, paddingBottom: 10, backgroundColor : mode === 'dark' ?  blackBg : white}}>
